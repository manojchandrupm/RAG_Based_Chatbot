...
# | 1) Here we added the React Agent with required React Agent Tools .   |
# | 2) Here the tools are used to retrieve the top 3 chunks related to   |
# | the user Query.                                                      |
# | 3) The Agent will select tools based on the user query .             |
